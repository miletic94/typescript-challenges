...
type Cat1 = { type: "cat"; name: string };
type Animal1 = { type: "cat" | "dog"; name: string };

type Test1 = { type: "cat" } extends Animal ? Animal : never; // Animal
type Test2 = { type: "dog" } extends Cat1 ? Cat1 : never; // never
