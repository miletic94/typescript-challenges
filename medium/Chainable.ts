...
//`Error: The key '${K}' already exists with a different type.`
type KeyNotIn<T, K extends string> = K extends keyof T
  ? `Error: The key '${K}' already exists with a different type.`
  : K;
...
type t = Alike<Expected2, Chainable>;
