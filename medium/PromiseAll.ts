...
*/
const arr = [1, 2, 3];
type Arr<T extends readonly any[]> = {
  [K in keyof T]: T[K];
};
function processTuple<T extends readonly any[]>(tuple: T) {
  type A = Arr<T>;
  // A will preserve the tuple structure
}

const a = processTuple([1, 2, 3]); // A is readonly [1, 2, 3]
